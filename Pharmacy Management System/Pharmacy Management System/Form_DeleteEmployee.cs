...
{
    public partial class Form_DeleteEmployee : Form
    {
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            if(cmb_EmpID.SelectedIndex == -1)
                MessageBox.Show(this, "Select an Employee ID and try again", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                if (MessageBox.Show("Are you sure you want to delete this data?", "Remove Data", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cmd.Parameters.AddWithValue("@EMPID", cmb_EmpID.SelectedValue.ToString());
